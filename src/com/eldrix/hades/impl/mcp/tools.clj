(ns com.eldrix.hades.impl.mcp.tools
  ...
  [{:name        "lookup"
   ...
   {:name        "translate"
    :description (str "FHIR ConceptMap $translate. Map a code from one CodeSystem to "
                      ...
                      "ConceptMap by source CodeSystem and target ValueSet or CodeSystem).")
    :inputSchema {:type       "object"
                  :properties {:code             code-schema
                               ...
                               :target           {:type        "string"
                                                  :description "Target ValueSet or CodeSystem URL (with `system`)."}
                               :version          version-schema
                               :display_language display-language-schema}
                  :required   ["code"]}
    :fn          tool-translate}
